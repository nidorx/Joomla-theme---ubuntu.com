...
<body>
<? echo JText::sprintf('REPORT_MESSAGE', $comment->author, $name); ?>
<br />
<br />
<a href="<? echo $object_link ?>#comment-<? echo $comment->id; ?>" target="_blank"><? echo $object_link; ?>#comment-<? echo $comment->id; ?></a>
<br />
<br />
<?
		if ($reason != '') {
?>
<? echo JText::_('REPORT_REASON'); ?>:
<div style="border: 1px solid #ccc; padding: 10px 5px; margin: 5px 0; font: normal 1em Verdana, Arial, Sans-Serif;"><? echo $reason; ?></div>
<?
		}
?>
<br />
<? echo JText::_('NOTIFICATION_COMMENT_TEXT'); ?>:
<br />
<br />
